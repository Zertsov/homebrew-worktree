class Worktree < Formula
  ...
  homepage "https://github.com/Zertsov/wt"
  version "0.0.1"
  license "MIT"

  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/Zertsov/wt/releases/download/v#{version}/worktree-#{version}-macos-arm64.tar.gz"
      sha256 "sha256:ff9b73ea5837e73a744c8df8bdf913b407df410b84660932b2d29c9b5040574c"
    else
      url "https://github.com/Zertsov/wt/releases/download/v#{version}/worktree-#{version}-macos-x64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.intel?
      url "https://github.com/Zertsov/wt/releases/download/v#{version}/worktree-#{version}-linux-x64.tar.gz"
